import threading
import ttkbootstrap as ttk # pour une interface graphique moderne
from ttkbootstrap.constants import * # pour les couleurs
from MPro3_downloader import youtube_to_mp3, youtube_to_mp4, get_video_title # module créé par nos soins 
from tkinter import messagebox # messagebox pour les messages d'erreur

# Création de la fenêtre principale
root = ttk.Window(themename="darkly")
root.title("MPro3 - M & W ©")
